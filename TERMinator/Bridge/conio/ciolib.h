...
CIOLIBEXPORT void ciolib_brightbackground(void);  // iCE mode - bright background for SGR 5
CIOLIBEXPORT void ciolib_reversevideo(void);       // SGR 7 - reverse video (swap fg/bg)
